...
public class LinkedListGUI extends JFrame {
    ...
    private void insertAction() {
        try {
            ...
            if (head == null) {
                ...
                head.InsertElement(head, newNode);
            }
    ...
    private void deleteAction() {
        try {
            int value = Integer.parseInt(inputField.getText());
            LinkedList nodeToDelete = new LinkedList(value);
            if (head != null) {
                head = head.deleteElement(head, nodeToDelete);
    ...
    private void searchAction() {
        try {
            int value = Integer.parseInt(inputField.getText());
            if (head != null) {
                head.searchData(head, value);
                updateOutput("Searched for: " + value);
            } else {
                updateOutput("List is empty.");
            }
        } catch (NumberFormatException ex) {
